...
class RestAwesomeGrailsPlugin extends Plugin {
    ...
    def title = "Rest Awesome" // Headline display name of the plugin
    def author = "Ejaz Ahmed"
    def authorEmail = "ejaz_ahmed@outlook.com"
    def description = '''\
This plugin adds pagination , sorting and include/exclude support in grails applications' default REST response.
'''
    def profiles = ['web']
...
//    def developers = [ [ name: "Joe Bloggs", email: "joe@bloggs.net" ]]
    ...
    def issueManagement = [ system: "Github", url: "https://github.com/ejaz-ahmed/grails-rest-awesome-plugin/issues" ]
